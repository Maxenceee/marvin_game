...
/*   Updated: 2023/06/26 23:10:24 by mgama            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	/* could not find MacOS equivalent for zenity, function only called on Linux */
	char	*cmd[] = {"zenity", "--info", "--width=500", "--title", "Well played!", "--text", "Did you love our little game? Nah, not sure about that. This time it was easy and soft, not everyone is nice so next time lock your session 😉\n", NULL};
